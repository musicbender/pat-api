...
// add health item
export const addHealthItem = async (
  input: HealthInputTypes,
...
// replace health item
export const replaceHealthItem = async (
  id: string,
  input: HealthInputTypes,
  config: HealthConfigType,
): Promise<HealthTypes> => {
...
// update health item
export const updateHealthItem = async (
  id: string,
  input: HealthInputUpdateTypes,
  config: HealthConfigType,
): Promise<Model> => {
  if (config.disabled) {
