...
describe('sample.ts', () => {
  describe('isWithinInterval()', () => {
    const tests: TestItem[] = [
      {
        assert: ['day', '2019-10-22T07:29:37-07:00', '2019-10-22T22:33:49-07:00'],
        expected: true,
      },
      {
        assert: ['day', '2019-10-22T10:36:31-07:00', '2019-10-22T22:33:49-07:00'],
        expected: true,
      },
      {
        assert: ['day', '2019-10-22T12:39:42-07:00', '2019-10-22T22:33:49-07:00'],
        expected: true,
      },
      {
        assert: ['day', '2019-10-22T16:22:34-07:00', '2019-10-22T22:33:49-07:00'],
        expected: true,
      },
      {
        assert: ['day', '2019-10-22T18:14:19-07:00', '2019-10-22T22:33:49-07:00'],
        expected: true,
      },
      {
        assert: ['day', '2019-10-22T21:48:55-07:00', '2019-10-22T22:33:49-07:00'],
        expected: true,
      },
      {
        assert: ['day', '2019-10-24T16:22:34-07:00', '2019-10-22T22:33:49-07:00'],
        expected: false,
      },
      {
        assert: ['day', '2019-10-21T16:22:34-07:00', '2019-10-22T22:33:49-07:00'],
        expected: false,
      },
      {
        assert: [null, '2019-10-22T16:22:34-07:00', '2019-10-22T22:33:49-07:00'],
        expected: true,
      },
    ];
  ...
  describe('getValidSources()', () => {
    const tests: TestItem[] = [
      {
        assert: [['pat-iphone'], null],
        expected: ['pat-iphone'],
      },
      {
        assert: [['pat-apple-watch'], null],
        expected: ['pat-apple-watch'],
      },
      {
        assert: [['pat-iphone', 'pat-apple-watch'], null],
      ...
      {
        assert: [null, ['pat-iphone']],
        expected: ['pat-iphone'],
      },
      {
        assert: [null, ['pat-apple-watch']],
        expected: ['pat-apple-watch'],
      },
      {
        assert: [['pat-iphone'], ['pat-apple-watch']],
        expected: ['pat-iphone'],
      },
      {
        assert: [['*'], null],
    ...
    tests.forEach(({ assert, expected }) => {
      it(`Given ${assert[0] ? assert[0].length : '0'} valid sources, ${
        assert[1]
      } is default, returns ${expected}`, () => {
  ...
  describe('findOutterValues()', () => {
    const tests: TestItem[] = [
      ...
      {
        assert: [[30, 56, 45, 99, 10, 11, 55], 'lowest'],
        expected: 10,
      },
      {
        assert: [[1, 2, -3], 'lowest'],
      ...
      {
        assert: [[1, 2, 3], 'highest'],
        expected: 3,
      },
      {
        assert: [[3, 1, 2], 'highest'],
        expected: 3,
      },
      {
        assert: [[999, 453, 337, 37, -12, 1000, 1001, 500], 'highest'],
        expected: 1001,
      },
      {
        assert: [[0, 100], 'highest'],
        expected: 100,
      },
      {
        assert: [[1], 'highest'],
      ...
      {
        assert: [[-100, -99], 'highest'],
        expected: -99,
      },
      {
        assert: [[22, 22], 'highest'],
        expected: 22,
      },
    ];
